#!/usr/bin/env python
"""
Example script demonstrating parser integration with MultiModelRAG

This example shows how to:
1. Process documents with MultiModelRAG using configurable parsers
...
def configure_logging():
    ...
    log_file_path = os.path.abspath(os.path.join(log_dir, "multi_model_rag_example.log"))
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "same Python process are also accepted when using MultiModelRAG as "
