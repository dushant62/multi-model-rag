"""
Processing callbacks and event system for MultiModelRAG.
...
Usage::
    ...
    from multi_model_rag.callbacks import ProcessingCallback, CallbackManager
...
class MetricsCallback(ProcessingCallback):
    ...
    def summary(self) -> str:
        ...
        m = self.metrics
        lines = [
            "MultiModelRAG Processing Metrics",
            "=" * 40,
