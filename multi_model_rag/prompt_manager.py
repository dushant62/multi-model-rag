"""
Prompt language management for MultiModelRAG.
...
Usage (process-global switch)::
    ...
    from multi_model_rag.prompt_manager import set_prompt_language, get_prompt_language
...
def register_prompt_language(language_code: str, prompts: Dict[str, Any]) -> None:
    ...
    Args:
        ...
        prompts: Dictionary of prompt templates, using the same keys as
                 :data:`multi_model_rag.prompt.PROMPTS`.

    Example::

        from multi_model_rag.prompt_manager import register_prompt_language
