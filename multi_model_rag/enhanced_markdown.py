...
class EnhancedMarkdownConverter:
    ...
    def convert_with_weasyprint(self, markdown_content: str, output_path: str) -> bool:
        ...
        try:
            ...
            self.logger.error(f"WeasyPrint conversion failed: {e!s}")
            return False
    ...
    def convert_with_pandoc(
        ...
        try:
            ...
            self.logger.error(f"Pandoc conversion failed: {e!s}")
            return False
            ...
            if temp_md_path and os.path.exists(temp_md_path):
                try:
                    ...
                    self.logger.error(f"Failed to clean up temp file {temp_md_path}: {e!s}")
    ...
    def convert_markdown_to_pdf(
        ...
        try:
            ...
            self.logger.error(f"{method.title()} conversion failed: {e!s}")
            return False
