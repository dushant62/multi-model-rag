...
PROMPTS["IMAGE_ANALYSIS_SYSTEM"] = (
    "You are an expert image analyst. Return valid JSON only with structured retrieval hints."
)
PROMPTS["IMAGE_ANALYSIS_FALLBACK_SYSTEM"] = (
    "You are an expert image analyst. Return valid JSON only with structured retrieval hints."
)
PROMPTS["TABLE_ANALYSIS_SYSTEM"] = (
    "You are an expert data analyst. Return valid JSON only with structured retrieval hints."
)
PROMPTS["EQUATION_ANALYSIS_SYSTEM"] = (
    "You are an expert mathematician. Return valid JSON only with structured retrieval hints."
)
PROMPTS["GENERIC_ANALYSIS_SYSTEM"] = (
    "You are an expert content analyst specializing in {content_type} content. Return valid JSON only with structured retrieval hints."
)
...
{{
    ...
    "retrieval_hints": {{
        "keywords": ["3-8 concrete retrieval keywords"],
        "observations": ["2-5 specific factual observations grounded in the image"],
        "relationships": ["0-3 explicit relationships between important elements"],
        "context_signals": ["0-3 links to nearby context, captions, or footnotes when relevant"]
    }}
}}
...
{{
    ...
    "retrieval_hints": {{
        "keywords": ["3-8 concrete retrieval keywords"],
        "observations": ["2-5 specific factual observations grounded in the table"],
        "relationships": ["0-3 explicit relationships between key rows, columns, or variables"],
        "context_signals": ["0-3 links to captions, notes, or nearby discussion when relevant"]
    }}
}}
...
{{
    ...
    "retrieval_hints": {{
        "keywords": ["3-8 concrete retrieval keywords"],
        "observations": ["2-5 specific mathematical observations grounded in the equation"],
        "relationships": ["0-3 explicit links to variables, terms, or related concepts"],
        "context_signals": ["0-3 links to surrounding theory, assumptions, or applications when relevant"]
    }}
}}
...
{{
    ...
    "retrieval_hints": {{
        "keywords": ["3-8 concrete retrieval keywords"],
        "observations": ["2-5 specific factual observations grounded in the content"],
        "relationships": ["0-3 explicit relationships between important elements"],
        "context_signals": ["0-3 links to nearby context when relevant"]
    }}
}}
