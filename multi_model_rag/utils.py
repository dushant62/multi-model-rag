"""
Utility functions for MultiModelRAG
...
def separate_content(
    content_list: List[Dict[str, Any]] | ParsedDocument,
    ...
    """
    if isinstance(content_list, ParsedDocument):
        text_content = content_list.text_content
        multimodal_items = content_list.multimodal_content_list
    else:
        text_parts = []
        multimodal_items = []
...
async def insert_text_content_with_multimodal_content(
    ...
    try:
        ...
        logger.info(
            "If the error is caused by the ainsert function not having a multimodal content parameter, please update the multi_model_rag branch of lightrag"
        )
